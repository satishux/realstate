							...
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="index.html" class="m-brand__logo-wrapper">
										<h6>Rising Street</h6>
										{{-- <img alt="" src="/dashboard/demo/default/media/img/logo/logo_default_dark.png"/> --}}
									</a>
								</div>
...
<!-- begin::Footer -->
					...
					<div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
						<div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
							<span class="m-footer__copyright">
								2018 &copy; Rising Street Infra City Private Ltd.
								<a href="/" class="m-link">
									Rising Street
								</a>
							</span>
		...
		<!--end::Base Scripts -->   
        <!--begin::Page Vendors -->
		<script src="/dashboard/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
		<!--end::Page Vendors -->  
        <!--begin::Page Snippets -->
		<script src="/dashboard/app/js/dashboard.js" type="text/javascript"></script>
		<!--end::Page Snippets -->
